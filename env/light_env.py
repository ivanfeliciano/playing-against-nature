...
class LightEnv(gym.GoalEnv):
    ...
    def __init__(self, horizon=5, num=5, cond="gt", structure="one_to_one", gc=True, filename=None, seen=10):
        ...
        #     __file__), 'assets', "arena_v2_"+str(num)+".xml")
        ...
        self.observation_space = spaces.Box(
            0, 1, shape=obs.shape, dtype='float32')
    ...
    def _sample_goal(self):
        ...
        light = light % 2
        # self.sim.model.light_active[:] = light
        # self.goalim = self.sim.render(
        #     mode='offscreen', width=84, height=84, camera_name="birdview") / 255.0
        return light
